...
<%@ taglib uri="jakarta.tags.functions" prefix="fn"%><!-- 函式庫 -->
...
<html>
	...
	<body>
		...
		<div style = "padding: 15px">
			<div class="pure-form">
				<fieldset>
					<legend>${userCert.username }歷史訂單</legend>
					<table class="pure-table pure-table-bordered">
						<thead>
							<tr>
								<th>訂單 Id</th><th>使用者 Id</th><th>訂單日期</th><th>商品 Id</th><th>商品名稱</th>
								<th>商品單價</th><th>訂購數量<th>小記</th><th>訂單狀態</th>
							</tr>
						</thead>
						<tbody>
						<!-- 初始化"總計"變數 -->
