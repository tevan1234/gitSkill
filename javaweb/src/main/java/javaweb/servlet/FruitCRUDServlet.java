 ...
 * 刪除水果路徑:/fruit/delete?name=apple & newName = pineapple 
 */

@WebServlet("/fruit/*")
public class FruitCRUDServlet extends HttpServlet{
	
	private List<String> fruits = new CopyOnWriteArrayList<>();//CopyOnWriteArrayList 可支援多人線上同時存取
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/read" :
			...
			break;
		case "/update": 
			int idx = fruits.indexOf(name); //找出需修改水果的 index
		...
		case "/delete": 
			...
			break;
		default:
			resp.getWriter().print("please input create/read/update/delete");
		}
	}	
}
