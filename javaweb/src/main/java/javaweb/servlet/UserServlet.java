...
public class UserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String active = req.getParameter("active"); // user_update 專用
		String userId = req.getParameter("userId"); // user_update 專用
		String oldpassword = req.getParameter("oldpassword");// update_password 專用
		String newpassword = req.getParameter("newpassword");// update_password 專用
